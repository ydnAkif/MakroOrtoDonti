...
| Test ve kalite güvence | %10 | 97 | 413 test, %95,93 toplam coverage, %89,49 branch coverage, %90 CI kapısı ve gerçek Chromium E2E |
...
```text
413 passed
Branch coverage: %89,49 (toplam branch-aware coverage: %95,93)
